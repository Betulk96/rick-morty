    ...
    return (
        <>
            ...
            <Container className="about-page">
                ...
                <Row className='mt-3'>
                    <Col md={2}>
                        <Image src="/images/about/rick.jpg" className="main-image" alt="rick" width={"100%"} height={"100%"} />
                    </Col>
                ...
                <Row className='mt-3'>
                    <Col md={2}>
                        <Image src="/images/about/morty.png" className="main-image" alt="morty" width={"100%"} height={"100%"} />
                    </Col>
                    <Col md={6} className='description'>
                ...
                <Row className='mt-3'>
                    <Col md={2}>
                        <Image src="/images/about/summer.png" className="main-image" alt="summer" width={"100%"} height={"100%"} />
                    </Col>
                    <Col md={6} className='description'>
                ...
                <Row className='mt-3'>
                    <Col md={2}>
                        <Image src="/images/about/beth.png" className="main-image" alt="beth" width={"100%"} height={"100%"} />
                    </Col>
                    <Col md={6} className='description'>
                ...
                <Row className='mt-3'>
                    <Col md={2}>
                        <Image src="/images/about/jerry.png" className="main-image" alt="jerry" width={"100%"} height={"100%"} />
                    </Col>
                    <Col md={6} className='description'>
